...
def sha512(infile, outFile):
    with open(infile, 'r') as file_to_hash:
        message = file_to_hash.read()
    # print(infile)
    messageBV = BitVector(textstring = message)
    fOUT = open(outFile, 'w')
    # print("message")
    # print(messageBV)
    ...
    K = ["428a2f98d728ae22", "7137449123ef65cd", 
    ...
    length = messageBV.length()
    bv1 = messageBV + BitVector(bitstring="1")
    length1 = bv1.length()
